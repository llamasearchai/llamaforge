...
def parse_args(args: List[str]) -> argparse.Namespace:
    ...
    list_parser.add_argument(
        "resource", choices=["models", "backends", "plugins"], help="Resource to list"
    )
    ...
    serve_parser.add_argument(
        "--port", type=int, default=8000, help="Port to bind server"
    )
    ...
    # Calculator tool
    calc_parser = tools_subparsers.add_parser(
        "calculator", help="Perform mathematical calculations"
    )
    ...
    benchmark_parser.add_argument(
        "--prompts", nargs="+", help="Prompts to use for benchmarking"
    )
    benchmark_parser.add_argument(
    ...
    benchmark_parser.add_argument(
        "--no-warmup", action="store_true", help="Skip warmup run"
    )
...
def chat_command(args: argparse.Namespace, forge: LlamaForge) -> None:
    ...
    if args.model:
        ...
        logger.error(
            "No model loaded. Please specify a model with --model or set a default model in the configuration."
        )
        return
...
def benchmark_command(args: argparse.Namespace, forge: LlamaForge) -> None:
    ...
    try:
        ...
        print(
            f"Average tokens per second: {results['overall']['avg_tokens_per_second']:.2f}"
        )
...
# Updated in commit 19 - 2025-04-04 17:04:10

# Updated in commit 27 - 2025-04-04 17:04:15

# Updated in commit 3 - 2025-04-05 14:24:48

# Updated in commit 11 - 2025-04-05 14:24:49

# Updated in commit 19 - 2025-04-05 14:24:49

# Updated in commit 27 - 2025-04-05 14:24:49

# Updated in commit 3 - 2025-04-05 15:00:42

# Updated in commit 11 - 2025-04-05 15:00:42

# Updated in commit 19 - 2025-04-05 15:00:43

# Updated in commit 27 - 2025-04-05 15:00:43

# Updated in commit 3 - 2025-04-05 15:10:25

# Updated in commit 11 - 2025-04-05 15:10:26

# Updated in commit 19 - 2025-04-05 15:10:26

# Updated in commit 27 - 2025-04-05 15:10:26

# Updated in commit 3 - 2025-04-05 15:37:50

# Updated in commit 11 - 2025-04-05 15:37:50

# Updated in commit 19 - 2025-04-05 15:37:50

# Updated in commit 27 - 2025-04-05 15:37:50

# Updated in commit 3 - 2025-04-05 16:43:04

# Updated in commit 11 - 2025-04-05 16:43:04

# Updated in commit 19 - 2025-04-05 16:43:04

# Updated in commit 27 - 2025-04-05 16:43:04

# Updated in commit 3 - 2025-04-05 17:13:31

# Updated in commit 11 - 2025-04-05 17:13:31

# Updated in commit 19 - 2025-04-05 17:13:32

# Updated in commit 27 - 2025-04-05 17:13:32

# Updated in commit 3 - 2025-04-05 18:02:07

# Updated in commit 11 - 2025-04-05 18:02:07

# Updated in commit 19 - 2025-04-05 18:02:07

# Updated in commit 27 - 2025-04-05 18:02:07

# Updated in commit 3 - 2025-04-05 18:26:57

# Updated in commit 11 - 2025-04-05 18:26:58

# Updated in commit 19 - 2025-04-05 18:26:58

# Updated in commit 27 - 2025-04-05 18:26:58

# Updated in commit 3 - 2025-04-05 19:06:09

# Updated in commit 11 - 2025-04-05 19:06:10

# Updated in commit 19 - 2025-04-05 19:06:10

# Updated in commit 27 - 2025-04-05 19:06:10
